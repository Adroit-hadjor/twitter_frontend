...
function OpenedTweetMiddleColumn() {
  let the_tweet = useSelector((state) => state.tweet);
  ...
  useEffect(() => {
    ...
    if (d) {
      setTweet(the_tweet);
      console.log(JSON.stringify(the_tweet))
      setUser(the_tweet.users_id);
      //setImages(the_tweet.images);
       setImages([]);
    } else {
      history.push("/");
    }
  ...
  if (the_tweet == "undefined") {
    return <div className="columns middle">loading....</div>;
  } else {
    return (
      <div className="columns middle">
        ...
        <div className="middle_body">
          ...
          <div className="opened_tweet">
              ...
              <div className="opened_tweet_avi_and_username">
                ...
                <div className="profile_name_1">
                  <div className="tab_left_name">
                    <text className="tab_left_1">{user.username}</text>
            ...
            <div className="opened_tweet_text">{tweet.tweet}</div>
            ...
            <div className="opened_tweet_likes">
              <text className="opened_tweet_likes_text">
                ...
                <text className="opened_tweet_likes_text_right">Retweets</text>
              </text>
              <text
                onClick={() => {
                  history.push("/quotes");
                }}
                className="opened_tweet_likes_text_middle"
              >
                <text className="opened_tweet_likes_text_left">18</text>
              ...
              <text className="opened_tweet_likes_text_last">
                ...
                <text className="opened_tweet_likes_text_right">Likes</text>
              </text>
            </div>
            <div className="opened_tweet_symbols">
              ...
              <div className="iconandtext">
                ...
                >
                  <path
                    d="M17.53 7.46999L12.53 2.46999C12.237 2.17699 11.762 2.17699 11.47 2.46999L6.47 7.46999C6.176 7.76299 6.176 8.23799 6.47 8.52999C6.764 8.82199 7.237 8.82399 7.53 8.52999L11.25 4.80999V15C11.25 15.414 11.586 15.75 12 15.75C12.414 15.75 12.75 15.414 12.75 15V4.80999L16.47 8.52999C16.616 8.67699 16.808 8.74999 17 8.74999C17.192 8.74999 17.384 8.67799 17.53 8.52999C17.823 8.23699 17.823 7.76299 17.53 7.46999V7.46999Z"
                    fill="#BBBBBB"
                  />
                  <path
                    d="M19.708 21.944H4.292C3.028 21.944 2 20.916 2 19.652V14C2 13.586 2.336 13.25 2.75 13.25C3.164 13.25 3.5 13.586 3.5 14V19.652C3.5 20.089 3.855 20.444 4.292 20.444H19.708C20.145 20.444 20.5 20.089 20.5 19.652V14C20.5 13.586 20.836 13.25 21.25 13.25C21.664 13.25 22 13.586 22 14V19.652C22 20.916 20.972 21.944 19.708 21.944V21.944Z"
                    fill="#BBBBBB"
                  />
                </svg>
              </div>
