...
import { setTweets, selectedTweet } from "../redux/actions/tweetsAction";
import { useCookies } from "react-cookie";
import CreateTweetSvg from "./createTweetSvg";
...
function MiddleColumn() {
  ...
  const getTweets = async () => {
    const posts = await Get("tweets", cookies.token);
    return posts;
  };
  ...
  const sendTweet = async () => {
    ...
    const response = await Post(url, body, cookies.token);
  };
                  ...
                  <div className="icon_group">
                    <CreateTweetSvg
                      comps={[
                        {
                          d:
                            "M17.736 16.8288C19.4393 16.8288 20.82 15.6494 20.82 14.1945C20.82 12.7397 19.4393 11.5603 17.736 11.5603C16.0328 11.5603 14.652 12.7397 14.652 14.1945C14.652 15.6494 16.0328 16.8288 17.736 16.8288Z",
                          fill: "rgb(29, 161, 242)",
                        },
                      ]}
                      link=""
                    ...
                    <CreateTweetSvg
                      comps={[
                        {
                          d:
                            "M41 4.46083H7C4.52 4.46083 2.5 6.68463 2.5 9.42296V43.6676C2.5 46.4015 4.52 48.6275 7 48.6275H41C43.48 48.6275 45.5 46.4015 45.5 43.6676V9.42296C45.5 6.68463 43.48 4.46083 41 4.46083V4.46083ZM42.5 43.6676C42.5 44.573 41.828 45.315 41 45.315H7C6.172 45.315 5.5 44.573 5.5 43.6676V9.42296C5.5 8.51313 6.172 7.77333 7 7.77333H41C41.828 7.77333 42.5 8.51313 42.5 9.42296V43.6676Z",
                          fill: "rgb(29, 161, 242)",
                        },
                      ]}
                      link=""
                    ...
                    <CreateTweetSvg
                      comps={[
                        {
                          d:
                            "M25.5 32.8038C21.4795 32.8038 17.7799 30.9829 15.606 27.9278C15.13 27.2608 15.3446 26.3753 16.0863 25.944C16.8258 25.5109 17.8118 25.7064 18.2878 26.3772C19.8751 28.6044 22.5718 29.9326 25.5021 29.9326C28.4325 29.9326 31.1291 28.6044 32.7186 26.3791C33.1946 25.7083 34.1806 25.5166 34.9201 25.9479C35.6639 26.3772 35.8764 27.2665 35.4004 27.9335C33.2223 30.9887 29.5226 32.8114 25.5021 32.8114L25.5 32.8038Z",
                          fill: "rgb(29, 161, 242)",
                        },
                        {
                          d:
                            "M31.3182 20.9607C33.0528 20.9607 34.459 19.6924 34.459 18.1278C34.459 16.5633 33.0528 15.295 31.3182 15.295C29.5837 15.295 28.1775 16.5633 28.1775 18.1278C28.1775 19.6924 29.5837 20.9607 31.3182 20.9607Z",
                          fill: "rgb(29, 161, 242)",
                        },
                        {
                          d:
                            "M19.6818 20.9607C21.4163 20.9607 22.8225 19.6924 22.8225 18.1278C22.8225 16.5633 21.4163 15.295 19.6818 15.295C17.9472 15.295 16.541 16.5633 16.541 18.1278C16.541 19.6924 17.9472 20.9607 19.6818 20.9607Z",
                          fill: "rgb(29, 161, 242)",
                        },
                      ]}
                      link=""
                      linkName="smiley"
                      id="smiley"
                      svgPath="M25.5 43.6042C12.903 43.6042 2.65625 34.362 2.65625 23C2.65625 11.638 12.903 2.39584 25.5 2.39584C38.097 2.39584 48.3438 11.638 48.3438 23C48.3438 34.362 38.097 43.6042 25.5 43.6042ZM25.5 5.27084C14.6625 5.27084 5.84375 13.225 5.84375 23C5.84375 32.775 14.6625 40.7292 25.5 40.7292C36.3375 40.7292 45.1562 32.775 45.1562 23C45.1562 13.225 36.3375 5.27084 25.5 5.27084Z"
                      width={25}
                      height={25}
                      fill={true}
                      strokeWidth={1}
                ...
                >
                  ...
                  <div className="tweet_upper">
                    ...
                    <div className="t_right">
                      <div className="upper_right">
                        <div className="namespace">
                          <div className="namespace_name">
                            {tweet.users_id.username}
                          </div>
                          <div className="namespace_username">
                            @{tweet.users_id.userusername} &#183; 21h
                          </div>
                        </div>
                        <div className="btn3">
                          <svg
                      ...
                      <div className="tweet_text">{tweet.tweet}</div>
